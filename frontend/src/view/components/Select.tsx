  ...
  return (
   <div>
      <div className='relative'>
        <label
          className={cn(
            'text-gray-700 absolute z-10 left-3 top-1/2 -translate-y-1/2 pointer-events-none',
        ...
        <RdxSelect.Root value={value} onValueChange={handleSelect}>
          <RdxSelect.Trigger
            className={cn(
              `h-[52px] w-full bg-white rounded-lg border border-gray-500 px-3 text-gray-800 focus:border-gray-800
