    ...
    <div>
      <DropdownMenu.Root>
        <DropdownMenu.Trigger>
          <button
            className={cn(
              `h-[52px] w-full bg-white rounded-lg border border-gray-500 px-3 text-gray-700 focus:border-gray-800
              transition-all outline-none text-left relative`,
          ...
          >
            ...
            <div className="absolute right-3 top-1/2 -translate-y-1/2">
              ...
              {selectedColor && <ColorIcon bg={selectedColor.bg} color={selectedColor.color}/>}
            </div>
          </button>
        </DropdownMenu.Trigger>
