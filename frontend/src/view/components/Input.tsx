...
export const Input = forwardRef<HTMLInputElement, InputProps>(({placeholder, name, id, error, className,...props}, ref) => {
  ...
  <div className="relative">
      <input
        ...
        placeholder=" "
        className={cn(
          'h-[52px] w-full bg-white rounded-lg border border-gray-500 px-3 text-gray-800 pt-4 peer placeholder-shown:pt-0 focus:border-gray-800 transition-all outline-none',
